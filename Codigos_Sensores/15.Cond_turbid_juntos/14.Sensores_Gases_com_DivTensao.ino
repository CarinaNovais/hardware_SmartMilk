...
// Fator do divisor (R1=10k, R2=10k → 1/0.5 = 2.0)
...
void loop()
{
  ...
  float tds = (133.42 * pow(v_real_tds, 3) - 255.86 * pow(v_real_tds, 2) + 857.39 * v_real_tds) * calibrationFactor;
  ...
  {
    ntu = -1120.4 * pow(v_real_ntu, 2) + 5742.3 * v_real_ntu - 4353.8;
  }
  if (ntu < 0)
    ntu = 0;
  ...
  Serial.print("ADC A1 (TDS): ");
  Serial.print(adc_tds);
  Serial.print(" | Vout: ");
  Serial.print(v_out_tds, 4);
  Serial.print(" V | Vreal: ");
  Serial.print(v_real_tds, 4);
  Serial.print(" V | TDS: ");
  Serial.print(tds, 2);
  Serial.println(" ppm");

  Serial.print("ADC A2 (Turbidez): ");
  Serial.print(adc_ntu);
  Serial.print(" | Vout: ");
  Serial.print(v_out_ntu, 4);
  Serial.print(" V | Vreal: ");
  Serial.print(v_real_ntu, 4);
  Serial.print(" V | NTU: ");
